...
const PaymentDetailsPage = () => {
  const transactions = [
    ...
    { id: 2, date: '2022-04-02', category: 'Shopping', name: 'Online Store ABC' },
    { id: 3, date: '2022-04-03', category: 'Utility', name: 'Electricity Bill' },
          ...
          <div className="max-w-md mx-auto">
            <div>
              ...
              <div className="mt-2 text-gray-500">
                <p>Balance: $50.00</p>
                <button className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded mt-2">Recharge</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 relative px-4 py-10 bg-white shadow rounded-3xl sm:p-10">
          <div className="max-w-md mx-auto">
            <div>
              ...
              <div className="mt-2 text-gray-500">
                <p>Balance: $100.00</p>
                <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-2">Withdraw</button>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-md mx-auto">
            <div className="text-left">
              ...
              <div className="border-b border-gray-300 pb-6">
                ...
                <p className="text-gray-500">Credit Card: **** **** **** 1234</p>
        ...
        <div className="mt-6 relative px-4 py-10 bg-white shadow rounded-3xl sm:p-10">
          <div className="max-w-md mx-auto">
              ...
              <tbody>
                {transactions.map(transaction => (
                  <tr key={transaction.id}>
                    ...
                    <td className={`border px-4 py-2 ${getColorByCategory(transaction.category)}`}>{transaction.category}</td>
            ...
            <div className="mt-4">
              ...
              <select id="categoryFilter" name="categoryFilter" className="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
